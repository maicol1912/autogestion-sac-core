...
public class UsuarioRepository {
    ...
    public UsuarioGeneralDto save(UsuarioGeneralDto u) throws DataAccessException{
        jdbcTemplate.update(INSERT_QUERY,u.getEpl_nroid(),u.getEpl_nroid(),CONTRASEÑA_USUARIOS,convertDate.obtenerLocalDate(),
                "I","N");

        jdbcTemplate.update(INSERT_USUARIO_POR_CAJA_LOG_1,69,u.getEpl_nroid(),"sai_perfilporusu","M","10.212.140.17",u.getEpl_nroid().toString()+
                " = Empresa: "+u.getEmp_empresa().toString()+" Puc: "+u.getPuc_puntoCredito().toString()+"indicador: N - S ",
                convertDate.obtenerLocalDate());

        jdbcTemplate.update(INSERT_USUARIO_POR_CAJA_LOG_2,69,u.getEpl_nroid(),"sai_perfilporusu","I","10.212.140.17","Indicador: "+
